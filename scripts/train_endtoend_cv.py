"""
③ KD-E2E Nested 5-fold GroupKFold 交差検証（評価用）
endtoend KD SingleModels×5は固定。fold毎にTeacherHeadを再学習後、生徒KD学習。
"""
...
RESULT_PATH      = f'/mnt/learn/usr/hayashi/引継ぎ/result/ECG_KD_student_endtoend_nested5fold_{alpha_str}/'
...
print('endtoend KD SingleModels（5個）をロードしました（固定）')
