"""
⑤ MOMENT-PartialUnfreeze 全被験者学習（検証なし・デプロイ用モデル保存）
...
RESULT_PATH      = f'/mnt/learn/usr/hayashi/引継ぎ/result/ECG_KD_student_MOMENT_PartialUnfreeze_allsubjects_{alpha_str}/'
...
print('教師⑤（MOMENT PartialUnfreeze）をロードしました')
