"""
⑥ MOMENT-FullFT Nested 5-fold GroupKFold 交差検証（評価用）
fold毎にMOMENT全パラメータ+HeadをFT後、生徒KD学習。
"""
import os, argparse
import numpy as np
import torch
...
from ecg_kd.models.torch.moment_utils import (
    load_moment, compute_teacher_preds_from_waveform
)
...
RESULT_PATH      = f'/mnt/learn/usr/hayashi/引継ぎ/result/ECG_KD_student_MOMENT_FullFT_nested5fold_{alpha_str}/'
...
for fold_idx, (train_idx, test_idx) in enumerate(fold_splits):
    ...
    print(f"  [Phase1] MOMENT FullFT + TeacherHeadを{TEACHER_EPOCHS}epoch学習中...")
